...
var listeners = (_a = {
    ...
    _a[handlesAnnouncements.name] = new Announcements_1["default"](handlesAnnouncements),
    _a[handlesCharacter.name] = new Character_1["default"](handlesCharacter),
    _a[handlesEnemyTarget.name] = new EnemyTarget_1["default"](handlesEnemyTarget),
    _a[handlesFriendlyTarget.name] = new FriendlyTarget_1["default"](handlesFriendlyTarget),
    _a[handlesControlGame.name] = new ControlGame_1["default"](handlesControlGame),
    _a[handlesControlGameScore.name] = new ControlGameScore_1["default"](handlesControlGameScore),
    _a
);
