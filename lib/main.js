...
var listeners = (_a = {
    ...
    _a[handlesAnnouncements.topic] = new Announcements_1["default"](handlesAnnouncements),
    _a[handlesCharacter.topic] = new Character_1["default"](handlesCharacter),
    _a[handlesEnemyTarget.topic] = new EnemyTarget_1["default"](handlesEnemyTarget),
    _a[handlesFriendlyTarget.topic] = new FriendlyTarget_1["default"](handlesFriendlyTarget),
    _a[handlesControlGame.topic] = new ControlGame_1["default"](handlesControlGame),
    _a[handlesControlGameScore.topic] = new ControlGameScore_1["default"](handlesControlGameScore),
    _a
);
